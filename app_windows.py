...
diff --git a/app_windows.py b/app_windows.py
new file mode 100644
index 0000000000000000000000000000000000000000..39368c92f1dbe6929f8d6a0adc6d8d8525f73fb3
--- /dev/null
+++ b/app_windows.py
@@ -0,0 +1,164 @@
...
+        self.root = root
+        self.root.title("Simple Python Autoclicker (Windows)")
...
+        raise SystemExit("app_windows.py is intended to run on Windows only.")
+

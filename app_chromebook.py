"""ChromeOS/Chromebook (Linux/Crostini) autoclicker GUI.

Note: On Chromebooks this is intended to run inside the Linux development
environment (Crostini). Global hotkeys and synthetic clicks can be limited by
your display server/session; if the hotkey fails, use the Start/Stop buttons.
"""
